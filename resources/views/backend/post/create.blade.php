    ...
    <div class="card-body">
      <form method="post" action="{{route('post.store')}}">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="summary" name="summary">{{old('summary')}}</textarea required>
          @error('summary')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="description" name="description">{{old('description')}}</textarea required>
          @error('description')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
