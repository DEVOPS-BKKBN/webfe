...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Daftar Berita</h6>
      <a href="{{route('post.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Tambah Berita</a>
    </div>
    <div class="card-body">
        ...
        <table class="table table-bordered" id="product-dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            @foreach($posts as $post)
              ...
              $cat = DB::table('post_categories')->select('title')->where('id',$post->post_cat_id)->get();
