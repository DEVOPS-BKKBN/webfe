...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Daftar Level</h6>
      <a href="{{route('level.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Tambah Level</a>
    </div>
    <div class="card-body">
                ...
                <tr>
                    ...
                    <td>
                        @if($level->status=='active')
                            <span class="badge badge-success">{{$level->status}}</span>
                        @else
                            <span class="badge badge-warning">{{$level->status}}</span>
                        @endif
                    </td>
