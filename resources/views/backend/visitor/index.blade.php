...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-body">
    <h6 class="m-0 font-weight-bold text-primary float-left">Pencarian Data Pengunjung</h6><br>
    <form method="post" action="{{route('visitor.store')}}">
        ...
        <input id="date" type="text" name="start" class="form-control" value="{{old('start')}}">
        @error('start')
        ...
        <input id="date2" type="text" name="end" class="form-control" autocomplete="off" value="{{old('end')}}">
        @error('end')
        <span class="text-danger">{{$message}}</span>
        @enderror
        </div>
    ...
    <div class="col-xl-12 col-lg-12 ">
        <div class="card shadow mb-4">
          ...
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Grafik Laporan Pengunjung Perbulan</h6>
