...
@section('title','PORTAL-BKKBN || Link Edit')
@section('main-content')

<div class="card">
    <h5 class="card-header">Ubah Link</h5>
    <div class="card-body">
      <form method="post" action="{{route('link.update',$link->id)}}">
        ...
        <input id="inputTitle" type="text" name="title" placeholder="Masukkan Judul"  value="{{$link->title}}" class="form-control">
        @error('title')
        ...
        <div class="input-group">
          ...
          <input id="thumbnail" class="form-control" type="text" name="photo" value="{{$link->photo}}">
        </div>
        ...
        <input id="inputLink" type="text" name="url" placeholder="Masukkan Link"  value="{{$link->url}}" class="form-control">
        @error('title')
        <span class="text-danger">{{$message}}</span>
        @enderror
        </div>
