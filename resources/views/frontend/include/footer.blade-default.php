      ...
      <div class="col pb-0 ">
        <div class="card border-0 text-white bg-transparent " style="box-shadow: none !important;">
          <div class="card-body">
            <?php
            if($bahasa == 3){
              echo '<span class="navbar-brand font-weight-bold text-white pb-2 pt-3" style="font-size: x-large;padding-left:1rem">PROFILE</span>';
            }else{
              echo '<span class="navbar-brand font-weight-bold text-white pb-2 pt-3" style="font-size: x-large;padding-left:1rem">PROFIL</span>';
            }
            ?>
      ...
      <div class="row row-cols-2 row-cols-md-2">
        ...
        <div class="col text-right" style="float:right">
          <p class=" d-inline text-white-50 text-right" style="font-size:15px;font-weight: 500;">
            ...
            <a href="https://api.whatsapp.com/send?phone=+628123456789&text=Halo" class="text-white text-decoration-none" style="border-right:1px solid #ffff;padding-right:5px;padding-left:5px">
            <?php
