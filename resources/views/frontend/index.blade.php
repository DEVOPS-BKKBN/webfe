      ...
      <div class="container-fluid cols-12">
        <div class="row no-gutter ">
          ...
          <div class="col-md-12 col-sm-12 col-lg-6 " style="background-color: #fff; margin-left:0px;">
              <div class="kalender"><a href="https://drive.google.com/drive/folders/1zFV6lk0jJahrf5HnUrWJpNreMAkd9-bq" target="_blank">
              <img src="/storage/photos/1/Pengumuman-CASN-2022.png" width="100%" height="100%" alt=""></a>
                <div></div>
              </div>
