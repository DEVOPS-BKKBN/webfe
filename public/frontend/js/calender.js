...
!function () {
	var data = [
		...
		{eventName: 'Lunch Meeting w/ Mark', calendar: 'Work', color: 'orange', eventTime: moment("2020-12-16")},
		...
		{eventName: 'Teach Kids to Code', calendar: 'Other', color: 'green', eventTime: moment("2020-12-19")},
		{eventName: 'Startup Weekend', calendar: 'Other', color: 'green', eventTime: moment("2020-12-31")}
	];
